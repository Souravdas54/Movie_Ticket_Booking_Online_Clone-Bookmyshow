...
//             // Find admin - handle both boolean true and string "true"
//             let admin = await userModel.findOne({
//                 $or: [
//                     { isSupportAdmin: true },
//                     { isSupportAdmin: "true" },
...
//             if (!admin) {
//                 // Don't redeclare 'admin' variable - remove 'const' keyword
...
//                 // Mark this admin as support admin for future
//                 admin.isSupportAdmin = true;
//                 await admin.save();
//             }
...
//                 isSupportChat: true,
//             }).populate('participants', 'name email profilePicture'); // Added populate
...
//             if (!admin) {
//                 return res.status(403).json({ message: "Unauthorized: Not a support admin" });
//             }
...
//             const admin = await userModel.findOne({ isSupportAdmin: true });
...
//                     participants: [
//                         new mongoose.Types.ObjectId(userId),
//                         new mongoose.Types.ObjectId(admin._id),
//                     ],
//                     isSupportChat: true,
//                 });
//             }
...
//             const chats = await chatModel.find({ participants: adminId }).sort({
//                 updatedAt: -1,
//             });
