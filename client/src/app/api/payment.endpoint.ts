...
interface ConfirmPaymentResponse {
  success: boolean;
  message?: string;
  data?: Record<string, unknown>; // ✅ Fix: replaced `any` with `Record<string, unknown>`
}
...
export const confirmPayment = async (paymentIntentId: string, bookingId: string): Promise<ConfirmPaymentResponse> => {
  try {
